...
var state;
var beat_listener; 
var chapter_listener;


function bind(model_name)
{
    var state_patch = this.patcher.parentpatcher.getnamed("model_name").patcher.getnamed("state");
    ...
    beat_listener       = new MaxobjListener(state.beat.number,     beat_value_changed);
    chapter_listener    = new MaxobjListener(state.beat.chapter,    chapter_value_changed);
}
