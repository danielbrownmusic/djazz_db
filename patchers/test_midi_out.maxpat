...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 268.0, 270.0, 77.0, 22.0 ],
					"text" : "clientwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 256.0, 193.0, 73.0, 22.0 ],
					"saved_object_attributes" : 					{
						"client_rect" : [ 1135, 188, 1535, 688 ],
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 188.0, 37.0, 56.0, 22.0 ],
					"text" : "autopattr",
					"varname" : "u653003195"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 118.0, 205.0, 89.0, 22.0 ],
					"text" : "djazz_midi_out",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 153.0, 101.0, 105.0, 22.0 ],
					"text" : "djazz_ui_midi_out"
				}
...
, 			{
				"name" : "djazz_effect_list_impl.maxpat",
				"bootpath" : "~/Documents/Max 8/Projects/djazz_db/patchers",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
