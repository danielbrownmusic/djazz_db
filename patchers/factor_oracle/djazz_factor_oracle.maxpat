...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 343.0, 643.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 343.0, 566.0, 61.0, 35.0 ],
					"text" : "v ORACLE"
				}
...
,
					"patching_rect" : [ 24.5, 485.0, 72.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 164.5, 485.0, 120.0, 22.0 ],
					"text" : "fo.state.add_link"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 262.0, 12.0, 147.0, 35.0 ],
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 34.0, 530.0, 352.5, 530.0 ],
					"source" : [ "obj-128", 0 ]
				}
