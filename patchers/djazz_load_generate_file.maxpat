...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 4,
					"outlettype" : [ "clear", "float", "int", "clear" ],
					"patcher" : 					{
						"fileversion" : 1,
						"appversion" : 						{
							"major" : 8,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"text" : "t clear 0. 0 clear"
								}

							}
, 							{
								"box" : 								{
									"comment" : "bang to clear patch data",
									"id" : "obj-40",
									"index" : 1,
									"maxclass" : "inlet",
									"numinlets" : 0,
...
, 							{
								"box" : 								{
									"comment" : "to patcher outlet going to dict",
									"id" : "obj-44",
									"index" : 1,
									"maxclass" : "outlet",
									"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 46.0, 239.0, 50.0, 22.0 ]
				}
