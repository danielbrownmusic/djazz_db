...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 127.0, 526.0, 67.0, 22.0 ],
					"text" : "opendialog"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "bang" ],
					"patching_rect" : [ 23.0, 526.0, 66.0, 22.0 ],
					"text" : "savedialog"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 127.0, 467.0, 69.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 371.0, 5.0, 69.0, 21.0 ],
					"text" : "Load",
					"texton" : "Load"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 23.0, 467.0, 69.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 447.0, 5.0, 69.0, 21.0 ],
					"text" : "Save",
					"texton" : "Save"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 572.0, 652.0, 204.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 16.0, 270.0, 126.0, 31.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 324.0, 187.0, 31.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 852.5, 30.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 21.0, 108.5, 53.0, 22.0 ],
					"text" : "pattrhub"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 32.5, 798.75, 234.5, 798.75 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-308", 0 ],
					"midpoints" : [ 136.5, 641.0, 234.5, 641.0 ],
					"order" : 1,
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 136.5, 798.75, 234.5, 798.75 ],
					"order" : 0,
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-308", 0 ],
					"midpoints" : [ 30.5, 401.0, 234.5, 401.0 ],
					"source" : [ "obj-51", 0 ]
				}
