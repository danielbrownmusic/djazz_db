...
,
					"patching_rect" : [ 584.0, 98.0, 41.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 342.0, 609.0, 282.999999999999886, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 54.06666666666672, 179.0, 142.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 177.06666666666672, 236.0, 50.0, 22.0 ],
					"varname" : "beat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.06666666666672, 24.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 262.56666666666672, 24.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 262.56666666666672, 98.0, 56.0, 22.0 ],
					"restore" : 					{
						"active" : [ 1 ],
						"beat" : [ 0 ],
						"tempo" : [ 0.0 ]
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 318.0, 236.0, 50.0, 22.0 ],
					"varname" : "tempo"
				}
...
,
					"patching_rect" : [ 177.06666666666672, 300.0, 108.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.199999999999989, 403.0, 42.866666666666731, 39.0 ],
					"varname" : "active"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 583.999999999999886, 22.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 318.0, 300.0, 59.0, 22.0 ],
					"text" : "tempo $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.06666666666672, 300.0, 61.0, 22.0 ],
					"text" : "nextevent"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 342.0, 496.0, 123.0, 22.0 ],
					"text" : "loadmess set #1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 92.766666666666708, 588.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 342.0, 674.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 342.0, 546.0, 19.0, 22.0 ],
					"text" : "r"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 54.06666666666672, 496.0, 212.5, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 593.5, 470.5, 63.56666666666672, 470.5 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 327.5, 280.0, 483.499999999999943, 280.0 ],
					"order" : 0,
					"source" : [ "obj-7", 0 ]
				}
