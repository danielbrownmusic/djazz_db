...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 679.0, 323.0, 29.5, 22.0 ],
					"text" : "t i b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 468.0, 430.0, 50.0, 22.0 ],
					"text" : "7."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 639.0, 218.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 617.0, 402.0, 72.0, 22.0 ],
					"text" : "gotobeat $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 778.0, 390.0, 61.0, 22.0 ],
					"text" : "nextevent"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 684.0, 31.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 595.0, 104.0, 131.0, 22.0 ],
					"text" : "nextevent, gotobeat $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 321.733333333333405, 470.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 48.0, 349.0, 264.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 282.933333333333394, 184.0, 213.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 282.933333333333394, 34.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 470.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 48.0, 253.0, 49.0, 22.0 ],
					"text" : "r #1"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 408.833333333333371, 311.0, 220.833333333333343, 311.0 ],
					"order" : 1,
					"source" : [ "obj-2", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 331.233333333333405, 280.0, 139.166666666666686, 280.0 ],
					"order" : 1,
					"source" : [ "obj-2", 1 ]
				}
