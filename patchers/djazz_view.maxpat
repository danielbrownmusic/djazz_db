...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "clear" ],
					"patching_rect" : [ 1078.0, 226.0, 58.0, 22.0 ],
					"text" : "t s clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "clear" ],
					"patching_rect" : [ 580.0, 226.0, 58.0, 22.0 ],
					"text" : "t s clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 236.0, 260.5, 226.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1074.75, 352.499999968749989, 481.5, 184.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 553.362882000000013, 247.0, 480.999999999999886, 193.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 1078.0, 282.5, 432.25, 21.5 ],
					"varname" : "score_file[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 580.0, 282.5, 402.75, 22.0 ],
					"varname" : "score_file",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 241.0, 741.0, 44.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 68.0, 25.0, 44.0, 22.0 ],
					"text" : "load",
					"texton" : "load"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 130.0, 741.0, 44.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.362881999999985, 25.0, 44.0, 22.0 ],
					"text" : "save",
					"texton" : "save"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 241.0, 780.0, 75.0, 22.0 ],
					"text" : "readagain, 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 130.0, 780.0, 107.0, 22.0 ],
					"text" : "writeagain, store 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2080.0, 783.0, 134.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 444.5, 780.0, 82.0, 22.0 ],
					"text" : "outputmode 6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 341.5, 780.0, 82.0, 22.0 ],
					"text" : "outputmode 0"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 236.0, 16.999999968749989, 415.0, 93.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 54.0, 538.362882000000013, 81.0 ],
					"varname" : "djazz_view_select_song_folder",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2080.0, 883.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1576.0, 352.499999968749989, 523.0, 350.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.362881999999985, 448.0, 1025.0, 482.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 1010.500000031250011, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 20.0, 130.0, 53.0, 22.0 ],
					"text" : "pattrhub"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.0, 1010.500000031250011, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 580.0, 352.499999968749989, 479.5, 184.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 553.362882000000013, 54.0, 480.999999999999886, 184.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 26.0, 352.499999968749989, 536.5, 291.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 140.0, 538.362882000000013, 300.0 ],
					"varname" : "master",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 16.999999968749989, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 1546.75, 676.499999968749989, 35.5, 676.499999968749989 ],
					"source" : [ "obj-25", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 1050.0, 678.499999968749989, 35.5, 678.499999968749989 ],
					"source" : [ "obj-37", 1 ]
				}
