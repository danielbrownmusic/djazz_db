...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "clear" ],
									"patching_rect" : [ 32.0, 83.0, 358.0, 22.0 ],
									"text" : "t s clear"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "init", "" ],
									"patching_rect" : [ 78.0, 216.0, 82.0, 22.0 ],
									"text" : "t init s"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 32.0, 136.0, 65.0, 22.0 ],
									"text" : "route clear"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 371.0, 401.0, 30.0, 30.0 ]
								}
...
,
									"patching_rect" : [ 141.0, 283.0, 122.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 0 ],
									"midpoints" : [ 150.5, 352.5, 380.5, 352.5 ],
									"source" : [ "obj-13", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 0 ],
									"midpoints" : [ 87.5, 352.0, 380.5, 352.0 ],
									"source" : [ "obj-6", 0 ]
								}
...
,
					"patching_rect" : [ 168.916682000000037, 527.0, 186.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"text" : "p load_initial_database_variables"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 159.0, 671.999999937499979, 119.0, 37.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 553.362882000000013, 7.999999937499979, 114.0, 35.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 107.5, 136.999999937499979, 133.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 107.5, 16.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 340.0, 299.499999937499979, 226.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1027.0, 467.499999937499979, 980.5, 296.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 340.0, 48.999999968749989, 517.0, 176.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 3.0, 526.0, 169.0 ],
					"varname" : "files",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 1526.0, 48.999999968749989, 481.5, 196.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 553.362882000000013, 286.0, 480.999999999999886, 193.0 ],
					"varname" : "midi_gen_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1988.5, 842.499999937499979, 134.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1988.5, 920.499999937499979, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 44.0, 1073.499999937499979, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 159.0, 1073.499999937499979, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 159.0, 779.499999937499979, 110.0, 76.0 ],
					"saved_object_attributes" : 					{
...
,
					"text" : "pattrstorage view_pattrstorage @greedy 1 @outputmode 5 @changemode 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 1027.0, 48.999999968749989, 479.5, 196.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 553.362882000000013, 93.0, 480.999999999999886, 184.0 ],
					"varname" : "midi_gen_1",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 332.5, 661.499999937499979, 532.0, 291.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 179.0, 538.362882000000013, 300.0 ],
					"varname" : "master",
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 117.0, 741.749999937499979, 168.5, 741.749999937499979 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"midpoints" : [ 847.5, 234.999999968749989, 926.5, 234.999999968749989, 926.5, 11.999999937499979, 1535.5, 11.999999937499979 ],
					"source" : [ "obj-14", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 598.5, 252.999999968749989, 976.5, 252.999999968749989, 976.5, 26.999999937499979, 1036.5, 26.999999937499979 ],
					"source" : [ "obj-14", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 342.0, 976.499999968749989, 53.5, 976.499999968749989 ],
					"source" : [ "obj-47", 0 ]
				}
