...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 370.0, 56.0, 45.0, 22.0 ],
					"text" : "deep 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 272.0, 56.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 272.0, 113.0, 143.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 225.0, 697.0, 44.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 9.0, 44.0, 22.0 ],
					"text" : "load",
					"texton" : "load"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 114.0, 697.0, 44.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.362881999999985, 9.0, 44.0, 22.0 ],
					"text" : "save",
					"texton" : "save"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 736.0, 75.0, 22.0 ],
					"text" : "readagain, 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.0, 736.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1096.0, 762.0, 134.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 443.0, 736.0, 82.0, 22.0 ],
					"text" : "outputmode 6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 736.0, 82.0, 22.0 ],
					"text" : "outputmode 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 549.0, 217.0, 219.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 748.0, 54.0, 415.0, 93.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 13.0, 40.0, 538.362882000000013, 85.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1096.0, 858.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 581.0, 338.0, 534.0, 336.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.362881999999985, 473.0, 1077.0, 484.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 27.0, 858.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 19.0, 138.0, 53.0, 22.0 ],
					"text" : "pattrhub"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 226.0, 942.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 226.0, 788.0, 104.0, 76.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 1129.0, 338.0, 473.5, 336.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 555.362882000000013, 40.0, 537.999999999999886, 236.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 27.0, 338.0, 541.0, 336.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 13.0, 135.0, 538.0, 334.0 ],
					"varname" : "master",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.0, 16.999999968749989, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "load (song navigate file and midi out bank components)",
					"id" : "obj-62",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 126.0, 16.999999968749989, 30.0, 30.0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-47::obj-3::obj-5" : [ "number[1]", "number", 0 ],
