...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 35.0, 63.0, 171.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 111.0, 114.0, 55.0, 22.0 ],
					"text" : "!/ 60000."
				}
...
, 			{
				"box" : 				{
					"comment" : "(int) non-zero: turns on metronome; zero: turns off ",
					"id" : "obj-5",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 35.0, 168.0, 95.0, 22.0 ],
					"text" : "metro 1000"
				}
